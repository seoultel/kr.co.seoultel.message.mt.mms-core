...
public class KtfVaspResMessageExceptionTest {

    private final String tid = "tid";
    private final String statusCode = "statusCode";
    private final String statusText = "statusText";
    private final String messageId = "messageId";

    @Test
    @DisplayName("MC-KVaspResME-1 : Test NoArgConstructor throws MCMPSoapRenderException when MessageFactory.newInstance throws SOAPException")
    void testNoArgConstructor() {
        ...
        try (MockedStatic<MessageFactory> messageFactoryMock = Mockito.mockStatic(MessageFactory.class)) {
            ...
            MCMPSoapRenderException thrownException = assertThrows(MCMPSoapRenderException.class, () -> new KtfResMessage(KtfProtocol.VASP_ERROR_RES));
    ...
    @Test
    @DisplayName("MC-KVaspResME-2 : Test AllArgConstructor throws MCMPSoapRenderException when MessageFactory.newInstance throws SOAPException")
    void testAllArgConstructor() {
        ...
        try (MockedStatic<MessageFactory> messageFactoryMock = Mockito.mockStatic(MessageFactory.class)) {
            ...
            MCMPSoapRenderException thrownException = assertThrows(MCMPSoapRenderException.class, () -> {
                    KtfResMessage ktfResMessage = new KtfResMessage(KtfProtocol.VASP_ERROR_RES);
    ...
    @Test
    @DisplayName("MC-KVaspResME-3 : Test toSOAPMessage throws MCMPSoapRenderException when setting properties throws Exception")
    void testToSOAPMessageWhenSettingPropertiesThrowsException() throws Exception {
        ...
        try (MockedStatic<MessageFactory> messageFactoryMock = Mockito.mockStatic(MessageFactory.class)) {
            ...
            KtfResMessage message = new KtfResMessage(KtfProtocol.VASP_ERROR_RES);
            message.setTid(tid);
    ...
    @Test
    @DisplayName("MC-KVaspResME-4 : Test toSOAPMessage throws MCMPSoapRenderException when adding SOAP elements throws Exception")
    void testToSOAPMessageWhenAddingSOAPElementsThrowsException() throws Exception {
        ...
        try (MockedStatic<MessageFactory> messageFactoryMock = Mockito.mockStatic(MessageFactory.class)) {
            ...
            // Set up the instance of KtfResMessage
            KtfResMessage message = new KtfResMessage(KtfProtocol.VASP_ERROR_RES);
            message.setTid(tid);
            message.setMessageId(messageId);
            message.setStatusCode(statusCode);
    ...
    @Test
    @DisplayName("MC-KVaspResME-5 : Test fromSOAPMessage throws MCMPSoapRenderException on parsing failure")
