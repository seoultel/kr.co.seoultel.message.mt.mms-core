...
public class LgtSubmitReqMessageExceptionTest {
    ...
    private final String originCode = "originCode";

    @Test
    @DisplayName("MC-LSReqME-1 : Test NoArgConstructor throws MCMPSoapRenderException when MessageFactory.newInstance throws SOAPException")
    void testNoArgConstructor() {
        ...
        try (MockedStatic<MessageFactory> messageFactoryMock = Mockito.mockStatic(MessageFactory.class)) {
            ...
            MCMPSoapRenderException thrownException = assertThrows(MCMPSoapRenderException.class, LgtSubmitReqMessage::new);
    ...
    @Test
    @DisplayName("MC-LSReqME-2 : Test AllArgConstructor throws MCMPSoapRenderException when MessageFactory.newInstance throws SOAPException")
    void testAllArgConstructor() {
        ...
        try (MockedStatic<MessageFactory> messageFactoryMock = Mockito.mockStatic(MessageFactory.class)) {
            ...
            MCMPSoapRenderException thrownException = assertThrows(MCMPSoapRenderException.class, () ->
                    new LgtSubmitReqMessage(tid, vaspId, vasId, callback, receiver, subject, originCode)
            );
    ...
    @Test
    @DisplayName("MC-LSReqME-3 : Test toSOAPMessage throws MCMPSoapRenderException when setting properties throws Exception")
    void testToSOAPMessageWhenSettingPropertiesThrowsException() throws Exception {
        ...
        try (MockedStatic<MessageFactory> messageFactoryMock = Mockito.mockStatic(MessageFactory.class)) {
            ...
            // Set up the instance of LgtSubmitReqMessage
            LgtSubmitReqMessage message = new LgtSubmitReqMessage(tid, vaspId, vasId, callback, receiver, subject, originCode);
    ...
    @Test
    @DisplayName("MC-LSReqME-4 : Test toSOAPMessage throws MCMPSoapRenderException when adding SOAP elements throws Exception")
    ...
    @Test
    @DisplayName("MC-LSReqME-5 : Test fromSOAPMessage throws MCMPSoapRenderException on parsing failure")
    void testFromSOAPMessageThrowsException() throws Exception {
        ...
        // Create LgtSubmitReqMessage instance
        LgtSubmitReqMessage message = new LgtSubmitReqMessage();
