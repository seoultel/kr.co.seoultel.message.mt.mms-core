...
public class SktDeliveryResMessageExceptionTest {
    @Test
    @DisplayName("MC-SDRResME-1 : Test NoArgConstructor throws MCMPSoapRenderException when MessageFactory.newInstance throws SOAPException")
    void testNoArgConstructor() {
        ...
        try (MockedStatic<MessageFactory> messageFactoryMock = Mockito.mockStatic(MessageFactory.class)) {
            ...
            MCMPSoapRenderException thrownException = assertThrows(MCMPSoapRenderException.class, SktDeliveryReportResMessage::new);
    ...
    @Test
    @DisplayName("MC-SDRResME-2 : Test AllArgConstructor throws MCMPSoapRenderException when MessageFactory.newInstance throws SOAPException")
    void testAllArgConstructor() {
        ...
        try (MockedStatic<MessageFactory> messageFactoryMock = Mockito.mockStatic(MessageFactory.class)) {
            ...
            MCMPSoapRenderException thrownException = assertThrows(MCMPSoapRenderException.class, () ->
                    new SktDeliveryReportResMessage(tid, statusCode, statusText)
            );
    ...
    @Test
    @DisplayName("MC-SDRResME-3 : Test toSOAPMessage throws MCMPSoapRenderException when setting properties throws Exception")
    void testToSOAPMessageWhenSettingPropertiesThrowsException() throws Exception {
        ...
        try (MockedStatic<MessageFactory> messageFactoryMock = Mockito.mockStatic(MessageFactory.class)) {
            ...
            // Set up the instance of SktDeliveryReportResMessage
            SktDeliveryReportResMessage message = new SktDeliveryReportResMessage("TID", "1000", "Success");
    ...
    @Test
    @DisplayName("MC-SDRResME-4 : Test toSOAPMessage throws MCMPSoapRenderException when adding SOAP elements throws Exception")
    ...
    @Test
    @DisplayName("MC-SDRResME-5 : Test fromSOAPMessage throws MCMPSoapRenderException on parsing failure")
    void testFromSOAPMessageThrowsException() throws Exception {
        ...
        // Create SktDeliveryReportResMessage instance
        SktDeliveryReportResMessage message = new SktDeliveryReportResMessage();
