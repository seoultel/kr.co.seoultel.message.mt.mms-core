...
public class KtfRsErrorResMessageExceptionTest {
    ...
    @Test
    @DisplayName("MC-KRsErrorME-1 : Test NoArgConstructor throws MCMPSoapRenderException when MessageFactory.newInstance throws SOAPException")
    void testNoArgConstructor() {
        ...
        try (MockedStatic<MessageFactory> messageFactoryMock = Mockito.mockStatic(MessageFactory.class)) {
            ...
            MCMPSoapRenderException thrownException = assertThrows(MCMPSoapRenderException.class, () -> new KtfResMessage(KtfProtocol.RS_ERROR_RES));
    ...
    @Test
    @DisplayName("MC-KRsErrorME-2 : Test AllArgConstructor throws MCMPSoapRenderException when MessageFactory.newInstance throws SOAPException")
    void testAllArgConstructor() {
        ...
        try (MockedStatic<MessageFactory> messageFactoryMock = Mockito.mockStatic(MessageFactory.class)) {
            ...
            MCMPSoapRenderException thrownException = assertThrows(MCMPSoapRenderException.class, () -> {
                    KtfResMessage ktfResMessage = new KtfResMessage(KtfProtocol.RS_ERROR_RES);
    ...
    @Test
    @DisplayName("MC-KRsErrorME-3 : Test toSOAPMessage throws MCMPSoapRenderException when setting properties throws Exception")
    void testToSOAPMessageWhenSettingPropertiesThrowsException() throws Exception {
        ...
        try (MockedStatic<MessageFactory> messageFactoryMock = Mockito.mockStatic(MessageFactory.class)) {
            ...
            KtfResMessage message = new KtfResMessage(KtfProtocol.RS_ERROR_RES);
            message.setTid(tid);
    ...
    @Test
    @DisplayName("MC-KRsErrorME-4 : Test toSOAPMessage throws MCMPSoapRenderException when adding SOAP elements throws Exception")
    ...
    @Test
    @DisplayName("MC-KRsErrorME-5 : Test fromSOAPMessage throws MCMPSoapRenderException on parsing failure")
