...
public class HistCertAckMessageTest {
    ...
    private static final String DELIVERY_PORT = "8080";
    private static final String REPORT_PORT = "9090";
    ...
    public void testConstructor() {
        ...
        assertEquals(message.getDeliveryPort(), "");
        assertEquals(message.getReportPort(), "");
    }
