...
public class LgtDeliveryReqMessageExceptionTest {
    ...
    @Test
    @DisplayName("MC-LDRReqME-1 : Test NoArgConstructor throws MCMPSoapRenderException when MessageFactory.newInstance throws SOAPException")
    void testNoArgConstructor() {
        ...
        try (MockedStatic<MessageFactory> messageFactoryMock = Mockito.mockStatic(MessageFactory.class)) {
            ...
            MCMPSoapRenderException thrownException = assertThrows(MCMPSoapRenderException.class, LgtDeliveryReportReqMessage::new);
    ...
    @Test
    @DisplayName("MC-LDRReqME-2 : Test AllArgConstructor throws MCMPSoapRenderException when MessageFactory.newInstance throws SOAPException")
    void testAllArgConstructor() {
        ...
        try (MockedStatic<MessageFactory> messageFactoryMock = Mockito.mockStatic(MessageFactory.class)) {
            ...
            MCMPSoapRenderException thrownException = assertThrows(MCMPSoapRenderException.class, () ->
                    new LgtDeliveryReportReqMessage());
    ...
    @Test
    @DisplayName("MC-LDRReqME-3 : Test toSOAPMessage throws MCMPSoapRenderException when setting properties throws Exception")
    void testToSOAPMessageWhenSettingPropertiesThrowsException() throws Exception {
        ...
        try (MockedStatic<MessageFactory> messageFactoryMock = Mockito.mockStatic(MessageFactory.class)) {
            ...
            // Set up the instance of LgtDeliveryReportReqMessage
            LgtDeliveryReportReqMessage message = new LgtDeliveryReportReqMessage(tid, messageId, receiver, callback, mmStatus);
    ...
    @Test
    @DisplayName("MC-LDRReqME-4 : Test toSOAPMessage throws MCMPSoapRenderException when adding SOAP elements throws Exception")
    ...
    @Test
    @DisplayName("MC-LDRReqME-5 : Test fromSOAPMessage throws MCMPSoapRenderException on parsing failure")
    void testFromSOAPMessageThrowsException() throws Exception {
        ...
        // Create LgtDeliveryReportReqMessage instance
        LgtDeliveryReportReqMessage message = new LgtDeliveryReportReqMessage();
