...
public class KtfSubmitResMessageExceptionTest {
    ...
    @Test
    @DisplayName("MC-KSResME-1 : Test NoArgConstructor throws MCMPSoapRenderException when MessageFactory.newInstance throws SOAPException")
    void testNoArgConstructor() {
        ...
        try (MockedStatic<MessageFactory> messageFactoryMock = Mockito.mockStatic(MessageFactory.class)) {
            ...
            MCMPSoapRenderException thrownException = assertThrows(MCMPSoapRenderException.class, () -> new KtfResMessage(KtfProtocol.SUBMIT_RES));
    ...
    @Test
    @DisplayName("MC-KSResME-2 : Test AllArgConstructor throws MCMPSoapRenderException when MessageFactory.newInstance throws SOAPException")
    ...
    @Test
    @DisplayName("MC-KSResME-3 : Test toSOAPMessage throws MCMPSoapRenderException when setting properties throws Exception")
    void testToSOAPMessageWhenSettingPropertiesThrowsException() throws Exception {
        ...
        try (MockedStatic<MessageFactory> messageFactoryMock = Mockito.mockStatic(MessageFactory.class)) {
            ...
            KtfResMessage message = new KtfResMessage(KtfProtocol.SUBMIT_RES);
            message.setTid(tid);
    ...
    @Test
    @DisplayName("MC-KSResME-4 : Test toSOAPMessage throws MCMPSoapRenderException when adding SOAP elements throws Exception")
    ...
    @Test
    @DisplayName("MC-KSResME-5 : Test fromSOAPMessage throws MCMPSoapRenderException on parsing failure")
