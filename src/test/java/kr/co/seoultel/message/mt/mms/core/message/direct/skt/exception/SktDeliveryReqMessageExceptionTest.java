...
public class SktDeliveryReqMessageExceptionTest {
    ...
    private String senderAddress = "senderAddress";
    private String statusCode = "statusCode";
    private String statusText = "statusText";

    @Test
    @DisplayName("MC-SDRReqME-1 : Test NoArgConstructor throws MCMPSoapRenderException when MessageFactory.newInstance throws SOAPException")
    void testNoArgConstructor() {
        ...
        try (MockedStatic<MessageFactory> messageFactoryMock = Mockito.mockStatic(MessageFactory.class)) {
            ...
            MCMPSoapRenderException thrownException = assertThrows(MCMPSoapRenderException.class, SktDeliveryReportReqMessage::new);
    ...
    @Test
    @DisplayName("MC-SDRReqME-2 : Test AllArgConstructor throws MCMPSoapRenderException when MessageFactory.newInstance throws SOAPException")
    void testAllArgConstructor() {
        ...
        try (MockedStatic<MessageFactory> messageFactoryMock = Mockito.mockStatic(MessageFactory.class)) {
            ...
            MCMPSoapRenderException thrownException = assertThrows(MCMPSoapRenderException.class, () ->
                    new SktDeliveryReportReqMessage(tid, messageId, receiver, senderAddress, statusCode, statusText));
    ...
    @Test
    @DisplayName("MC-SDRReqME-3 : Test toSOAPMessage throws MCMPSoapRenderException when setting properties throws Exception")
    void testToSOAPMessageWhenSettingPropertiesThrowsException() throws Exception {
        ...
        try (MockedStatic<MessageFactory> messageFactoryMock = Mockito.mockStatic(MessageFactory.class)) {
            ...
            // Set up the instance of SktDeliveryReportReqMessage
            SktDeliveryReportReqMessage message = new SktDeliveryReportReqMessage(tid, messageId, receiver, senderAddress, statusCode, statusText);
    ...
    @Test
    @DisplayName("MC-SDRReqME-4 : Test toSOAPMessage throws MCMPSoapRenderException when adding SOAP elements throws Exception")
    ...
    @Test
    @DisplayName("MC-SDRReqME-5 : Test fromSOAPMessage throws MCMPSoapRenderException on parsing failure")
    void testFromSOAPMessageThrowsException() throws Exception {
        ...
        // Create SktDeliveryReportReqMessage instance
        SktDeliveryReportReqMessage message = new SktDeliveryReportReqMessage();
