...
public class SktSubmitResMessageExceptionTest {


    @Test
    @DisplayName("MC-SSResME-1 : Test NoArgConstructor throws MCMPSoapRenderException when MessageFactory.newInstance throws SOAPException")
    void testNoArgConstructor() {
        ...
        try (MockedStatic<MessageFactory> messageFactoryMock = Mockito.mockStatic(MessageFactory.class)) {
            ...
            MCMPSoapRenderException thrownException = assertThrows(MCMPSoapRenderException.class, SktSubmitResMessage::new);
    ...
    @Test
    @DisplayName("MC-SSResME-2 : Test AllArgConstructor throws MCMPSoapRenderException when MessageFactory.newInstance throws SOAPException")
    void testAllArgConstructor() {
        ...
        try (MockedStatic<MessageFactory> messageFactoryMock = Mockito.mockStatic(MessageFactory.class)) {
            ...
            MCMPSoapRenderException thrownException = assertThrows(MCMPSoapRenderException.class, () ->
                    new SktSubmitResMessage(tid, statusCode, statusText, messageId)
            );
    ...
    @Test
    @DisplayName("MC-SSResME-3 : Test toSOAPMessage throws MCMPSoapRenderException when setting properties throws Exception")
    void testToSOAPMessageWhenSettingPropertiesThrowsException() throws Exception {
        ...
        try (MockedStatic<MessageFactory> messageFactoryMock = Mockito.mockStatic(MessageFactory.class)) {
            ...
            // Set up the instance of SktSubmitResMessage
            SktSubmitResMessage message = new SktSubmitResMessage("TID", "1000", "Success", "MSG_ID");
    ...
    @Test
    @DisplayName("MC-SSResME-4 : Test toSOAPMessage throws MCMPSoapRenderException when adding SOAP elements throws Exception")
    ...
    @Test
    @DisplayName("MC-SSResME-5 : Test fromSOAPMessage throws MCMPSoapRenderException on parsing failure")
    void testFromSOAPMessageThrowsException() throws Exception {
        ...
        // Create SktSubmitResMessage instance
        SktSubmitResMessage message = new SktSubmitResMessage();
