...
public class KtfDeliveryReportReqMessageExceptionTest {

    private final String tid = "tid";
    private final String messageId = "messageId";
    private final String receiver = "receiver";
    private final String callback = "callback";
    private final String mmStatus = "mmStatus";


    @Test
    @DisplayName("MC-KDRReqME-1 : Test NoArgConstructor throws MCMPSoapRenderException when MessageFactory.newInstance throws SOAPException")
    void testNoArgConstructor() {
        ...
        try (MockedStatic<MessageFactory> messageFactoryMock = Mockito.mockStatic(MessageFactory.class)) {
            ...
            MCMPSoapRenderException thrownException = assertThrows(MCMPSoapRenderException.class, KtfDeliveryReportReqMessage::new);
    ...
    @Test
    @DisplayName("MC-KDRReqME-2 : Test AllArgConstructor throws MCMPSoapRenderException when MessageFactory.newInstance throws SOAPException")
    void testAllArgConstructor() {
        ...
        try (MockedStatic<MessageFactory> messageFactoryMock = Mockito.mockStatic(MessageFactory.class)) {
            ...
            MCMPSoapRenderException thrownException = assertThrows(MCMPSoapRenderException.class, () ->
                    new KtfDeliveryReportReqMessage(tid, messageId, receiver, callback, mmStatus)
            );
    ...
    @Test
    @DisplayName("MC-KDRReqME-3 : Test toSOAPMessage throws MCMPSoapRenderException when setting properties throws Exception")
    void testToSOAPMessageWhenSettingPropertiesThrowsException() throws Exception {
        ...
        try (MockedStatic<MessageFactory> messageFactoryMock = Mockito.mockStatic(MessageFactory.class)) {
            ...
            // Set up the instance of KtfDeliveryReportReqMessage
            KtfDeliveryReportReqMessage message = new KtfDeliveryReportReqMessage(tid, messageId, receiver, callback, mmStatus);
    ...
    @Test
    @DisplayName("MC-KDRReqME-4 : Test toSOAPMessage throws MCMPSoapRenderException when adding SOAP elements throws Exception")
    ...
    @Test
    @DisplayName("MC-KDRReqME-5 : Test fromSOAPMessage throws MCMPSoapRenderException on parsing failure")
    void testFromSOAPMessageThrowsException() throws Exception {
        ...
        // Create KtfDeliveryReportReqMessage instance
        KtfDeliveryReportReqMessage message = new KtfDeliveryReportReqMessage();
