...
public class HistBindMessageTest {
    ...
    protected static final String TYPE = "testType";
    protected static final String KIND = "testKind";
    protected static final String VERSION = "testVersion";
    protected static final String KEYPOS = "kyps";
    ...
    public void testConstructor() {
        ...
        assertEquals(histBindMessage.getVersion(), "");
        assertEquals(histBindMessage.getKeypos(), "");
    }
