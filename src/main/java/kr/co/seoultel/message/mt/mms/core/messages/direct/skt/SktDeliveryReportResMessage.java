...
public class SktDeliveryReportResMessage extends SktSoapMessage {
    ...
    public SktDeliveryReportResMessage() throws MCMPSoapRenderException {
    }

    @Builder
    public SktDeliveryReportResMessage(String tid, String statusCode, String statusText) throws MCMPSoapRenderException {
        this.tid = tid;
    ...
    public SOAPMessage toSOAPMessage() throws MCMPSoapRenderException {
        try {
            ...
            throw new MCMPSoapRenderException("[SOAP] Fail to create SktDeliveryReportResMessage from SOAPMessage", e);
        }
    }
