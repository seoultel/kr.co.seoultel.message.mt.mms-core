...
public class SktSubmitResMessage extends SktSoapMessage {
    ...
    public SktSubmitResMessage() throws MCMPSoapRenderException {
    }

    @Builder
    public SktSubmitResMessage(String tid, String statusCode, String statusText, String messageId) throws MCMPSoapRenderException {
        this.tid = tid;
    ...
    public SOAPMessage toSOAPMessage() throws MCMPSoapRenderException {
        try {
            ...
            throw new MCMPSoapRenderException("[SOAP] Fail to create SktSubmitResMessage", e);
        }
    }
    ...
    public void fromSOAPMessage(SOAPMessage soapMessage) throws MCMPSoapRenderException {
        try {
            ...
            throw new MCMPSoapRenderException("[SOAP] Fail to create SktSubmitResMessage from SOAPMessage", e);
        }
    }
}
